...
class MotionDevice:
    ...
    _status_callback: Callable[[int, int, int, MotionSpeedLevel, MotionPositionInfo], None] = None
    ...
    def register_position_callback(self, callback: Callable[[int, int, MotionPositionInfo], None]) -> None:
        """Register the callback used to update the position."""
        self._position_callback = callback

    def register_running_callback(self, callback: Callable[[MotionRunningType], None]) -> None:
    ...
    def register_status_callback(
        self, callback: Callable[[int, int, int, MotionSpeedLevel, MotionPositionInfo], None]
    ) -> None:
